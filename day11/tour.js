...
var number_pattern=/^[9,8,70-9]{10}/;
...
document.getElementById("result").innerHTML="Invalid Adhaar Number"
check++;
}
else if(input_card.match(card_pattern)==null){

document.getElementById("result").innerHTML="Invalid CVV Number";
check++;
}
else {
...
if(package1==package_input)
{
    ...
    if(total_persons>num)
    {
        ...
        document.getElementById("result").innerHTML="Total amount Rs."+amt+" is paid successfully. Tour booking is confirmed! Tour check-in Date is "+date;
    }
}
...
if(total_persons>num)
{
    ...
    document.getElementById("result").innerHTML="No Selection was made";
}
